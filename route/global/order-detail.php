                ...
                <tbody>
                    <?php
                        ...
                        if(isset($_SESSION["user_id"])) {
                            ...
                            $sql = "SELECT order_id, order_user_name, order_user_location, order_user_phone, order_total FROM tb_order WHERE user_id = $userID";
                            ...
                            if(mysqli_num_rows($result) > 0){
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    echo "<tr>";
                                        ...
                                        echo "<th><a href=../.././src/process-delete-order.php?id=".$row["order_id"]." class='btn btn-danger'>Delete</a></th>";
                                    echo "</tr>";
                                }
                            } else {
                                echo '
                                    <div class="order-empty">
                                        <h3 class="text-center global-color">Đơn hàng của bạn trống rỗng</h3>
